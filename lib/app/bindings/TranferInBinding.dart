import 'package:application/app/controllers/tranferin/tranferin_controller.dart';
...
class TranferInBinding implements Bindings {
  @override
  void dependencies() {
    Get.lazyPut(() => TranferInController(
        repository:
